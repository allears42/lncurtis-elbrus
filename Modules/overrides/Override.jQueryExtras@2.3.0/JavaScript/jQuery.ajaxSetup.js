...
define('jQuery.ajaxSetup', ['jQuery','underscore','Utils'], function (jQuery,_)
{
	...
	jQuery(document).ready(function ()
	{
        ...
        // show loader on smaller screens, just apply css to have it load in the center of screen
		...
		var icon_height = !(SC && SC.ENVIRONMENT && SC.ENVIRONMENT.isTouchEnabled) ? 32 : 16
		,	icon_width = !(SC && SC.ENVIRONMENT && SC.ENVIRONMENT.isTouchEnabled) ? 32 : 16;
