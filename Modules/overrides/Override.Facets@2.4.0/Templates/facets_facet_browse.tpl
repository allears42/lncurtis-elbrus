...
<section class="facets-facet-browse">
	...
	<div id="banner-section-bottom-outer" class="content-banner banner-section-bottom-outer" data-cms-area="item_list_banner_bottom_outer" data-cms-area-filters="page_type"></div>
</section>
