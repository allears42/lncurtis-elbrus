...
<div id="{{cartOptionId}}-container" class="product-views-option-text print-hide" data-type="option" data-cart-option-id="{{cartOptionId}}" data-item-option-id="{{itemOptionId}}">
