...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var start = function(){
            ...
            // if there are pages bind the event
			if (slider.settings.touchEnabled && !slider.settings.ticker && getPagerQty() > 1) initTouch();
		}
		...
		var onTouchMove = function(e){
			...
			if(slider.settings.mode != 'fade' && slider.settings.oneToOneTouch && getPagerQty() > 1){
				var value = 0;
