				...
				{{else}}
					<div class="cart-item-summary-item-list-actionable-container-qty">
						...
						<div class="cart-item-summary-item-list-actionable-input-qty">
							...
							<input type="number" data-type="cart-item-quantity-input" name="quantity" id="quantity-{{lineId}}" class="cart-item-summary-quantity-value quantity-{{lineId}}" value="{{line.quantity}}" min="1" {{#if showMawQuantity}}max="{{maxQuantity}}"{{/if}}/>
