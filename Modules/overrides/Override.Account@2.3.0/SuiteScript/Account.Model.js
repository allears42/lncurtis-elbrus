	...
	,	register: function (user_data)
		{
            ...
            try {
                ...
                var customerData = ModelsInit.customer.getFieldValues();

                var customValues = {
                    "custentity_website_source" : "2"
                    , "custentity_targetmarket" : "1"
                    , "custentity_salesregion" : "1"
                    , "custentity_department" : "36"
                    , "custentity_internal_notes" : "Lead created from LNCurtis.com register form"
                    , "salesrep" : "53161"
                    , "custentity_lncs_created_by" : "115114"
                };
                ...
                nlapiLogExecution('DEBUG', ' register ', 'field values set');
            }
            catch (e){
