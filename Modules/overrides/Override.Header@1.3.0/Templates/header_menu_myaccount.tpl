...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-item-level2 header-menu-myaccount-level2-orders" data-permissions="{{purchasesPermissions}}" data-permissions-operator="OR">
		<a class="header-menu-myaccount-anchor-level2" href="#" data-action="push-menu" name="orders" data-touchpoint="customercenter" data-hashtag="#purchases">
			{{translate 'Purchases'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
	...
	{{#if isProductListsEnabled}}
		<li class="header-menu-myaccount-item-level2">
			<a class="header-menu-myaccount-anchor-level2" href="#" data-action="push-menu" data-touchpoint="customercenter" data-hashtag="#wishlist" name="wishlist">
	...
	<!-- Billing -->
	<li class="header-menu-myaccount-item-level2">
		<a class="header-menu-myaccount-anchor-level2" href="#" data-action="push-menu" name="billing" data-permissions="transactions.tranCustInvc.1, transactions.tranCustCred.1, transactions.tranCustPymt.2, transactions.tranCustDep.1, transactions.tranDepAppl.1,transactions.tranStatement.2"  data-permissions-operator="OR">
			{{translate 'Billing'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#balance" name="accountbalance" data-permissions="transactions.tranCustInvc.1">{{translate 'Account Balance'}}</a>
			</li>
			<li>
	...
	<!-- Settings -->
	<li class="header-menu-myaccount-item-level2">
		<a class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="settings"  data-touchpoint="customercenter" data-hashtag="#profileinformation">
			{{translate 'Settings'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
		<ul class="header-menu-myaccount-level3">
	...
	<!-- todo: load based on customer type if allowed for b2b
	<li class="header-menu-myaccount-item-level2" data-permissions="lists.listCase.2">
		<a  class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="cases" data-touchpoint="customercenter" data-hashtag="#cases">
			{{translate 'Cases'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
		<ul class="header-menu-myaccount-level3">
