	...
	,	get: function (data)
		{
			...
			//TODO:  Add call to PaceJet model here.  Need to figure out what data needs to be set to.
			// order is a global set in Models.Init.js.
			...
			try {
                ...
                if (!data.confirmation) {
                    PacejetModel.updateOrder(order_fields, result, order, data);
				}
			}
			catch (e) {
                nlapiLogExecution('DEBUG', 'exception calling pacejet', e);
			}
