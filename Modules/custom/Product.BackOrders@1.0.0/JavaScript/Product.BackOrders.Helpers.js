/*
	...
	These functions can be used on any quantity control
*/

define(
    'Product.BackOrders.Helpers'
    ,	[
        'LiveOrder.Model'
    ,   'Backbone'
    ...
    )
    {
        ...
        return Backbone.View.extend(
        {
	        initialize: function (options) {
		        var self = this;
		        // we will pass the model we want to use
		        // should be a product model
        ...
        ,	setQuantity: function setQuantity (e)
	        {
		        ...
		        this.checkForAllowableQuantity(new_quantity, $input_quantity);
	    ...
	    ,   getContext: function ()
	        {
		        ...
		        return {
			        ...
			        , showBackorderMessage: !this.allowBackorders && current_quantity >= allowed_quantity && this.stock_level > 0
