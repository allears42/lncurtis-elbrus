...
define(
	...
	, function (ProductDetailsBaseView
		, ProductDetailsFullView
		, ProductDetailsQuickViewView
		, _) {
		'use strict';
		
		function generateViewBindings()
		{
			var self = this
				...
				bindings['[name="' + cart_option_id + '"]'] = {
					...
					, update: function ($el, val, model, options) {
						...
						//console.log($el, val, model, options)
						...
						var setOptionFromValue = function ($el, obj, selectedVal) {
							...
							//console.log(selectedVal, obj.active);
							
							$el.append(option);
						};
						
						// handle this option
						var optionModel = product_model.get('options').findWhere({cartOptionId: options.observe})
		...
		_.extend(ProductDetailsBaseView.prototype, {
			generateViewBindings: generateViewBindings
